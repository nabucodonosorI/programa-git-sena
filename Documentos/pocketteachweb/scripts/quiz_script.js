...
let shuffledQuestions, currentQuestionIndex, correctAnswersCounter

//Starts the game and sets the next question when a question was aready answered
...
//Function to start the quiz. Hides the start button, randomizes the questions and options, set the value of the index of that shows the specific question. Shows the container of the question, and shows the next question.
...
//Invoques two functions, the function that resets the question and the function responsible of showing the next question.
function setNextQuestion() {
    resetState()
    showQuestion(shuffledQuestions[currentQuestionIndex])
}

//Function that renderizes the question shown in next question.
...
function selectAnswer(e) {
    ...
    submitButton.addEventListener('click', () => {
        ...
        if(correct){
            ...
            shuffledQuestions[currentQuestionIndex].answers.push({ usersCorrectAnswer: true })
        }else{
            shuffledQuestions[currentQuestionIndex].answers.push({ usersCorrectAnswer: false })
        }
        setStatusClass(document.body, correct)
        //answerButtonsElement.push()
        Array.from(answerButtonsElement.children).forEach(button => {
            //Inser counting function here
        ...
        if (shuffledQuestions.length > currentQuestionIndex + 1 ) {
            ...
            for (i in shuffledQuestions) {
                if (shuffledQuestions[i].answers.usersCorrectAnswer){
